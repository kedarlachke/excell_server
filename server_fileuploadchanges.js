...
// Make executable schema commented on 20181020
...
//const schemaExecutable = makeExecutableSchema({ graphQLSchema, resolvers })
...
// New GraphQL endpoint [ Send request and reponse in context ] commented on 20181020
...
server.use('/excellinv',apolloUploadExpress({ maxFileSize: 10000000, maxFiles: 10 }),graphqlHTTP( (request, response) => ({
  schema: graphQLSchema,
  rootValue: resolvers,
  graphiql: true,
  context: { request, response }
