...
const ProcessServerCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            let duplicateObj =  await checkDuplicateProcessServer(cases);
            ...
            {
                affectedRecords = await createProcessServer(cases);
            }*/
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateProcessServer(cases);
            }*/
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteProcessServer(cases);
            }*/
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteProcessServer(cases);
            }*/
...
const validateCREATEProcessServerData = async (cases) =>
{
    try 
    {
        ...
        for(let i = 0; i < cases.length; i++)
        {
            ...
            validations.checkNull("HOURSOFWK", cases[i].HOURSOFWK, "Hours of Work is required", validationObject);
            validations.checkNull("CASEDT", cases[i].CASEDT, "Case Date is required", validationObject);
            validations.checkNull("AT", cases[i].AT, "AT is required", validationObject);
            ...
            validations.checkNull("TYPE", cases[i].TYPE, "Type is required", validationObject);
            ...
            validations.checkNull("DEPT", cases[i].DEPT, "Department is required", validationObject);
...
const checkDuplicateProcessServer = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
const createProcessServer = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
const updateProcessServer = async (cases) =>
{
    try 
    {   
        let updateStatement;             
        ...
        // Use database service to update table data
        for(let j = 0; j < updateStatements.length; j++)
        {
            result = await dbServices.executeQuery(updateStatements[j]) ;    
            //console.log("result => ");  console.log(result);
...
const logicalDeleteProcessServer = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteProcessServer = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
        ...
        // Use database service to delete table data
        for(let j = 0; j < deleteStatements.length; j++)
        {
            result = await dbServices.executeQuery(deleteStatements[j]) ;    
            //console.log("result => ");  console.log(result);
...
const AssetSearchCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            // Check uniqueness of input data
            let duplicateObj =  await checkDuplicateAssetSearch(cases);
            ...
            {
                affectedRecords = await createAssetSearch(cases);
            }
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateAssetSearch(cases);
            }
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteAssetSearch(cases);
            }
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteAssetSearch(cases);
            }
...
// Function to check uniqueness of data
const checkDuplicateAssetSearch = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
// function for creating cases records
const createAssetSearch = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
// function for updating cases records
const updateAssetSearch = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for logically deleting cases records
const logicalDeleteAssetSearch = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteAssetSearch = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
...
const InfidelityCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            // Check uniqueness of input data
            let duplicateObj =  await checkDuplicateInfidelity(cases);
            ...
            {
                affectedRecords = await createInfidelity(cases);
            }
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateInfidelity(cases);
            }
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteInfidelity(cases);
            }
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteInfidelity(cases);
            }
...
const validateCREATEInfidelityData = async (cases) =>
{
    try 
    {
        ...
        for(let i = 0; i < cases.length; i++)
        {
            ...
            validations.checkNull("DAYSFORSUR", cases[i].DAYSFORSUR, "Specific days are required", validationObject);
...
// Function to check uniqueness of data
const checkDuplicateInfidelity = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
// function for creating cases records
const createInfidelity = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
// function for updating cases records
const updateInfidelity = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for logically deleting cases records
const logicalDeleteInfidelity = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteInfidelity = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
...
const ChildCustodyCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            // Check uniqueness of input data
            let duplicateObj =  await checkDuplicateChildCustody(cases);
            ...
            {
                affectedRecords = await createChildCustody(cases);
            }
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateChildCustody(cases);
            }
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteChildCustody(cases);
            }
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteChildCustody(cases);
            }
...
// Function to check uniqueness of data
const checkDuplicateChildCustody = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
// function for creating cases records
const createChildCustody = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
// function for updating cases records
const updateChildCustody = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for logically deleting cases records
const logicalDeleteChildCustody = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteChildCustody = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
...
const LocatePeopleCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            // Check uniqueness of input data
            let duplicateObj =  await checkDuplicateLocatePeople(cases);
            ...
            {
                affectedRecords = await createLocatePeople(cases);
            }
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateLocatePeople(cases);
            }
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteLocatePeople(cases);
            }
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteLocatePeople(cases);
            }
...
// Function to check uniqueness of data
const checkDuplicateLocatePeople = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
// function for creating cases records
const createLocatePeople = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
// function for updating cases records
const updateLocatePeople = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for logically deleting cases records
const logicalDeleteLocatePeople = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteLocatePeople = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
...
const WorkersCompCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            // Check uniqueness of input data
            let duplicateObj =  await checkDuplicateWorkersComp(cases);
            ...
            {
                affectedRecords = await createWorkersComp(cases);
            }
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateWorkersComp(cases);
            }
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteWorkersComp(cases);
            }
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteWorkersComp(cases);
            }
...
// Function to check uniqueness of data
const checkDuplicateWorkersComp = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
// function for creating cases records
const createWorkersComp = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
// function for updating cases records
const updateWorkersComp = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for logically deleting cases records
const logicalDeleteWorkersComp = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteWorkersComp = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
...
const OtherCaseCRUDOps = async (args, context, info) =>
{
    ...
    {                        
        ...
        if(transaction == "CREATE")     // Create 
        {
            ...
            // Check uniqueness of input data
            let duplicateObj =  await checkDuplicateOtherCase(cases);
            ...
            {
                affectedRecords = await createOtherCase(cases);
            }
        ...
        else if(transaction == "UPDATE")    // Update
        {
            ...
            {
                affectedRecords = await updateOtherCase(cases);
            }
        ...
        else if(transaction == "LOGICAL_DELETE")    // Logical delete
        {
            ...
            {
                affectedRecords = await logicalDeleteOtherCase(cases);
            }
        ...
        else if(transaction == "PHYSICAL_DELETE")   // Physical delete
        {
            ...
            {
                affectedRecords = await physicalDeleteOtherCase(cases);
            }
...
// Function to check uniqueness of data
const checkDuplicateOtherCase = async (cases) =>
{
    try 
    {
        // Placeholders for prepared query
...
// function for creating cases records
const createOtherCase = async (cases) =>
{
    try 
    {                        
        let insertDML = `
...
// function for updating cases records
const updateOtherCase = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for logically deleting cases records
const logicalDeleteOtherCase = async (cases) =>
{
    try 
    {   
        let updateStatement;             
...
// function for phyically deleting clases records
const physicalDeleteOtherCase = async (cases) =>
{
    try 
    {   
        let deleteStatement;             
