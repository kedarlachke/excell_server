...
//const dbConnectionPool=require('../config/db/dbConnect')
...
const checkIfTableExist = async (tableName) =>
{
    const query=`SELECT COUNT(*) COUNT FROM information_schema.tables WHERE  table_name = '${tableName}' AND TABLE_SCHEMA='${process.env.DATABASE}';`
    try 
    {
